            ...
            <main className="w-full max-w-[440px] flex flex-col gap-6 relative z-10">
                ...
                >
                    <form className="flex flex-col gap-5" onSubmit={(e) => e.preventDefault()}>
                        ...
                        <button className="w-full py-4 bg-[#bc13fe] text-white font-black rounded-2xl active-glow hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2 mt-2" onClick={() => setLoading(true)}>
                            {loading ? 'KIRINYAPTI...' : 'KIRISH'}
                            <LogIn size={20} />
                        </button>
                    </form>
                </motion.div>

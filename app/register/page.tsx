      ...
      <main className="w-full max-w-[480px] flex flex-col gap-6 relative z-10">
        ...
        <nav className="flex p-1.5 bg-white/5 rounded-2xl glass-border-gradient" role="tablist">
          {roles.map((r) => (
            <button
              ...
              className={`flex-1 py-3 text-center flex items-center justify-center gap-2 rounded-xl font-bold text-xs uppercase tracking-wider transition-all duration-500 ${
                role === r.id 
        ...
        >
          ...
          <form className="flex flex-col gap-4" onSubmit={(e) => e.preventDefault()}>
            ...
            <button className="w-full py-4 bg-[#bc13fe] text-white font-black rounded-2xl active-glow hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2 mt-4">
              HISOB YARATISH
              <ArrowRight size={20} />
            </button>
          </form>
